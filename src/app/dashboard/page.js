        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg flex items-center justify-center gap-2 transition shadow-sm font-semibold"
            >
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-gray-800">Nouvelle demande de congés</h2>
                <button
              ...
              <LeaveRequestForm onSuccess={() => { handleLeaveCreated(); setShowRequestModal(false); }} />
            </div>
          </div>
        </div>
      )}
